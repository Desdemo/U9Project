...
{
	public partial class PriceTypeUIModelAction : BaseAction
	{
		private static readonly ILogger logger = LoggerManager.GetLogger(typeof(PriceTypeUIModelAction));
		//强类型化基类Model属性.
		public new PriceTypeUIModelModel CurrentModel 
		{
			get {
				return (PriceTypeUIModelModel)base.CurrentModel;
			}
			set {
		...
		public PriceTypeUIModelAction(IPart part) : base(part)
		{
		}
		//Model参数的构造,用于测试用例.
		public PriceTypeUIModelAction(PriceTypeUIModelModel model) : base(model)
		{
		}
		/// <summary>
		/// Help: 
