...
{
	[Serializable]
	public partial class PriceListRefModel : UIModel
	{
		#region Constructor
		public PriceListRefModel() : base("PriceListRef")
		{
			InitClass();
			this.SetResourceInfo("82a5e4be-43af-449e-b8a8-b247f4df486a");
            try{
			    AfterInitModel();
		...
		//just for Clone 
		private PriceListRefModel(bool isInit) : base("PriceListRef")
		{}
		protected override IUIModel CreateCloneInstance()
		{
			return new PriceListRefModel(false);
		}
		#endregion
		#region member
		#region views
		...
		private void InitClass()
		{
			...
			this.viewcRef.SetResourceInfo("a4527c6e-7df4-42c7-a007-abf2752ba253");
	...
	{
		#region Constructor
		public cRefView(IUIModel model) : base(model,"cRef","UFIDA.U9.Cust.BLT.ShipPlan.LogisticsBE.PriceList", true)
		{
			InitClass();
		}
		//构造空实例,不进行初始化.目前为Clone使用.
		private cRefView():base(null,"cRef","UFIDA.U9.Cust.BLT.ShipPlan.LogisticsBE.PriceList", true)
		{
		}
		...
		private void InitClass()
		{
			UIModelRuntimeFactory.AddNewUIField(this,"ID", typeof(Int64), false,"","System.Int64", "ID", true,true, false, "",false,(UIFieldType)1,"ba391065-6c27-4c82-acc8-b52b1c93a910","6af73d99-6704-4733-866b-9748485cdd2f");
			UIModelRuntimeFactory.AddNewUIField(this,"DocNo", typeof(String), false,"","System.String", "DocNo", true,true, false, "",false,(UIFieldType)1,"3d174255-fd12-47f7-8844-3b5e4fae9e8c","83f7be28-3770-4f1f-957f-0d54b5f7ea7c");
			UIModelRuntimeFactory.AddNewUIField(this,"Name", typeof(String), false,"","System.String", "Name", true,true, false, "",false,(UIFieldType)1,"3d174255-fd12-47f7-8844-3b5e4fae9e8c","a99c0689-15ac-4e21-b822-44d798924f4b");
			UIModelRuntimeFactory.AddNewUIField(this,"Supplier_Name", typeof(String), true,"","System.String", "Supplier.Name", false,true, false, "",true,(UIFieldType)1,"3d174255-fd12-47f7-8844-3b5e4fae9e8c","5efdf52b-dcf3-4daa-8669-8d8f61190c09");
	...
	public class cRefRecord : UIRecord
	{
		...
		{
			get{
				//object value = this[this.uiviewcRef.FieldSupplier_Name] ;
				//return (String)value;
				return GetValue<String>(this.uiviewcRef.FieldSupplier_Name);
			}
			set{
				this[this.uiviewcRef.FieldSupplier_Name] = value;
			}
		}
		#endregion
	}
	...
	public class cRefDefaultFilterFilter : UIFilter
	{
		...
		public cRefDefaultFilterFilter(IUIView view) 
			: base("DefaultFilter",view,@"",@" order by DocNo desc")
		{
			InitClass();
		}
