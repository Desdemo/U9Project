...
/***********************************************************************************************
 * Form ID:0d359f87-f761-46ac-8226-9e9d30f78bc3 
 * Form Name:LogisticsConstsBListUIForm
 * UIFactory Auto Generator
 ***********************************************************************************************/
namespace UFIDA.U9.Cust.BLT.ShipPlan.LogisticsConstsUI
{
	[FormRegister("UFIDA.U9.Cust.BLT.ShipPlan.LogisticsConstsUI","UFIDA.U9.Cust.BLT.ShipPlan.LogisticsConstsUI.LogisticsConstsBListUIFormWebPart", "UFIDA.U9.Cust.BLT.ShipPlan.LogisticsConstsUI.WebPart", "0d359f87-f761-46ac-8226-9e9d30f78bc3","WebPart", "True", 992, 504)] 
	///insert into aspnet_Parts (SysVersion, Path, ClassName, [Assembly], FormId) values (0, 'UFIDA.U9.Cust.BLT.ShipPlan.LogisticsConstsUI', 'UFIDA.U9.Cust.BLT.ShipPlan.LogisticsConstsUI.LogisticsConstsBListUIFormWebPart', 'UFIDA.U9.Cust.BLT.ShipPlan.LogisticsConstsUI.WebPart', '0d359f87-f761-46ac-8226-9e9d30f78bc3')
	///<siteMapNode url="~/erp/simple.aspx?lnk=0d359f87-f761-46ac-8226-9e9d30f78bc3" title="LogisticsConstsBListUIForm"/>
    public partial class LogisticsConstsBListUIFormWebPart : UFSoft.UBF.UI.FormProcess.BaseWebForm
    {
		#region Page Controller/Code Behind
        private static readonly ILogger logger = LoggerManager.GetLogger(typeof(LogisticsConstsBListUIFormWebPart));
        private string assemblyName = System.Reflection.Assembly.GetExecutingAssembly().FullName;
        //private string displayNamePostfix = "displayName";

		#region 强类型化基类属性.
		public new LogisticsConstsBListUIModelAction Action
		{
			get { return (LogisticsConstsBListUIModelAction)base.Action; }
			set { base.Action = value; }
		}
		LogisticsConstsBListUIModelModel _uimodel=null;
		public new LogisticsConstsBListUIModelModel Model
		{
			get 
			{
			     if(_uimodel == null){
			          _uimodel = new LogisticsConstsBListUIModelModel();
			     }
			     return _uimodel; 
			}
			set { _uimodel = value; }
        ...
        protected override IUIModel UIModel{
            ...
            set{
                this.Model = value as LogisticsConstsBListUIModelModel;
            }
        }
		#endregion 
        ...
        #region constructor
        public LogisticsConstsBListUIFormWebPart()
        {
            FormID = "0d359f87-f761-46ac-8226-9e9d30f78bc3";
	...
	//获取档案版型结果: 
		...
		protected override void OnLoadDataDo(EventArgs e)
		{
			...
			{
				if(this.Model==null){				        
					this.Model = new LogisticsConstsBListUIModelModel();
				}
			...
			{
				//去除.已经移入到OnInit()中.
				//this.Model = (LogisticsConstsBListUIModelModel)this.CurrentState[this.TaskId.ToString()];
			}
		...
		{			 
            ...
            this.Action = new LogisticsConstsBListUIModelAction(this);
        ...
        {
            IUFContainer _panel = UIControlBuilder.BuildTopLevelContainer(this,"LogisticsConstsBListUIForm",true,992,504);
        ...
        private void _BuilderControl_Toolbar1(IUFContainer container)
        {
            ...
            ///foreach Toolbar下的所有控件，增加到此容器
                            this.BtnNew = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnNew", "True", "True", 35, 28,"1", "N",true,false,"19478b02-d2a9-4d7e-b7af-00070c61ff2d","19478b02-d2a9-4d7e-b7af-00070c61ff2d","4817b4db-3a36-45af-b61f-57bf26415a56");
		
            UIControlBuilder.SetButtonAccessKey(this.BtnNew);
            this.BtnNew.UIModel = this.Model.ElementID;
            this.BtnNew.Action = "OnNew";
	                            this.BtnDelete = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnDelete", "True", "True", 35, 28,"2", "R",true,false,"0467218f-229b-4954-b2d4-3c5976467f76","0467218f-229b-4954-b2d4-3c5976467f76","e4d2ec88-341e-490b-9935-45209e1d1da8");
            ...
            this.BtnDelete.Action = "OnDelete";
	                            _Toolbar.Controls.Add(new UFWebToolbarSeparatorAdapter());
			                            this.BtnOutPut = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnOutPut", "True", "True", 35, 28,"4", "O",true,false,"688fd549-5a92-49cc-8072-6d5377f6409a","688fd549-5a92-49cc-8072-6d5377f6409a","d11a6b17-9113-4c26-a19b-326bd11b8d2e");
            ...
            this.BtnOutPut.Action = "OnOutPut";
	                            this.BtnPrint = UIControlBuilder.BuilderToolbarButton(_Toolbar, "True", "BtnPrint", "True", "True", 35, 28,"5", "P",true,false,"27b5c615-cde5-458c-be74-833317249568","27b5c615-cde5-458c-be74-833317249568","7ccafd22-a522-45eb-8bfd-225f3ae68209");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card0",false,"FunctionBar", true, true, "3","","2669d0f5-388d-474b-b645-c0681c334ce0");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.Label0 = UIControlBuilder.BuilderUFLabel(_UFCard, "Label0", "", "True", "True", "Right", 80, 20, 13, 0, 1, 1, "100","7fb97e0d-d794-43d8-9b10-4ea28a2d6bd3","90dcadaf-d34f-429c-b716-e8bff799b587");
			...
			UIControlBuilder.BuilderUFControl(this.Label0, "2");		
		        ...
		        this.DDLCase = UIControlBuilder.BuilderDropDownList(_UFCard, "DDLCase", "", true,  true, true, "Left", 0, 60, 0, 120, 20, 15, 0, 1, 1, "100",true,false,"","","cb8a9687-e4e8-4890-9752-a3293a78a434");
			...
			UIControlBuilder.BuilderUFControl(this.DDLCase, "3");		
				...
				this.OnLookCase = UIControlBuilder.BuilderUFButton(_UFCard, true, "OnLookCase", true, true, 80, 20, 0, 0, 1, 1, "100","", this.Model.ElementID,"OnLookCase",false,"5facf0f3-3e7e-4837-a0b5-fbbbb51c8da0","5facf0f3-3e7e-4837-a0b5-fbbbb51c8da0","acb129c5-4787-4e3f-a956-b9c9f0e09baa");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card3",false,"none", true, true, "2","","65a0574d-71ff-4125-adf9-9ce6d9404e19");
		...
		{
			QryService.BindEnum("DDLCase", this, "a52d789a-109a-418f-94c3-050bb23d5c2c");
		}
